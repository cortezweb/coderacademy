<section>
    <h1 class="text-2xl font-bold">REQUIRIMIENTOS DEL CURSO</h1>
    <hr class="mt-2 mb-6">
    ...
    <article class="card">  
        <div class="card-body bg-gray-100">
            <form wire:submit.prevent="store">
                <input wire:model="name" class="form-input w-full" placeholder="Agregar el nombre de un requirimiento">
                ...
                <div class="flex justify-end mt-2">
                    <button type="sumit" class="btn btn-primary">Agregar requirimiento</button>
                </div>
            </form> 
        </div>
