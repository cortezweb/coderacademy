    ...
    <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
        <figure>
           @if ($course->image)
            ...
            @else
                <img class="h-60 w-full object-cover"  src="https://images.pexels.com/photos/4497761/pexels-photo-4497761.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="">
        ...
        <div class="text-white">
            ...
            <p><i class="fas fa-start"></i> Calificacion {{$course->rating}}</p>
        </div>
    ...
    <div class="order-1 lg:order-2">
        ...
        <section class="card mb-4">
            ...
            <form action="{{route('admin.courses.approved', $course)}}" class="mt-4" method="POST">
                ...
                <button  class="btn btn-primary w-full">Aprovar curso</button>
            </form>
